...
results_dir = 'round3_results'
results = []

# Read all round 3 result files
...
# Save results
df.to_csv('round3_summary.csv', index=False)

print("="*80)
print("ROUND 3 ANALYSIS RESULTS - HIGH-POTENTIAL SUBREDDITS")
print("="*80)
